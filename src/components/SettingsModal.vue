    ...
    >
      ...
      <div class="flex-1 flex flex-col bg-transparent overflow-hidden">
        <div class="flex-1 p-4 overflow-y-auto">
          ...
          <div v-if="activeTab === 'universal-window'" class="thinhm-handshake-signal space-y-4">
            ...
            <template v-for="w in store.widgets" :key="'iframe-' + w.id">
              <div
                v-if="w.type === 'iframe'"
                class="thinhm-handshake-signal flex flex-col gap-3 p-4 border border-gray-100 rounded-xl bg-gray-50 hover:bg-white hover:shadow-md transition-all"
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4">
                    <div
                ...
                <div class="w-full bg-white/60 p-3 rounded-lg border border-gray-100 space-y-3">
                  ...
                  <p class="text-[10px] text-gray-500 mt-1">
                    点击<a
                      href="/thinhm-helper.zip"
                      download="thinhm-helper.zip"
                      target="_blank"
            ...
            <div class="bg-gray-50 border border-gray-100 rounded-xl p-4">
              <div class="flex items-start gap-2 mb-3">
                ...
                <p class="text-xs text-gray-600 leading-relaxed">
                  thinhm 会自动检测您的网络环境。如果检测到您处于内网（如家庭 Wi-Fi），
                  应用卡片会自动切换到内网地址以提高速度。
                  <br />
                  如果您使用了<b>内网穿透</b>或<b>P2P工具</b>（如 FRP, ZeroTier, Tailscale），
                  请将这些域名或 IP 段添加到下方白名单中，以便 thinhm 将其识别为“内网环境”。
                </p>
              </div>
