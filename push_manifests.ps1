...
try {
    ...
    docker manifest create --amend qdnas/thinhm:1.0.26BC qdnas/thinhm:1.0.26BC-amd64 qdnas/thinhm:1.0.26BC-arm64
    Write-Host "Pushing Manifest for 1.0.26BC..."
    docker manifest push qdnas/thinhm:1.0.26BC
} catch {
...
try {
    ...
    docker manifest create --amend qdnas/thinhm:latest qdnas/thinhm:1.0.26BC-amd64 qdnas/thinhm:1.0.26BC-arm64
    Write-Host "Pushing Manifest for latest..."
    docker manifest push qdnas/thinhm:latest
} catch {
